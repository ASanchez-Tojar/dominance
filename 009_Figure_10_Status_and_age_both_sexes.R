...
# tiff("plots/talks/Figure10_Status_and_age_both_sexes.tiff", height=20, width=20,
#      units='cm', compression="lzw", res=300)

tiff("plots/talks/9interactions/Figure10_Status_and_age_both_sexes_9int.tiff", height=20, width=20,
     units='cm', compression="lzw", res=300)
...
plot(data.plot1$age, 
     ...
     #cex.lab=1.7,
     cex.lab=2.4,
     xaxt="n",yaxt="n",xlim=c(0.5,6.5),ylim=c(0,1),
     family="serif",
     frame.plot = FALSE)

title(xlab="age", line=4, cex.lab=3.0, family="serif")
title(ylab="Standardized Elo-rating", line=4.5, cex.lab=3.0, family="serif")

axis(1,at=seq(0.5,6.5,by=1),
     #cex.axis=1.3,
     cex.axis=1.8,
     family="serif")
...
points(jitter(data.plot1.m$age,1.0), 
       data.plot1.m$StElo, 
       pch = 19, col=rgb(darkblue[1],darkblue[2],darkblue[3],0.4),
       cex = 2.0)

points(jitter(data.plot1.f$age,1.0), 
       data.plot1.f$StElo, 
...
newdat.f6 <- newdat[newdat$age<6.01,]

index.f6<-newdat.f6$sex=="0"

polygon(c(newdat.f6$age[index.f6],rev(newdat.f6$age[index.f6])),
        c(newdat.f6$lower[index.f6],rev(newdat.f6$upper[index.f6])),
        border=NA,col=rgb(chocolate1[1], chocolate1[2], chocolate1[3], 0.15))

lines(newdat$age[index.m], newdat$fit[index.m], lwd=3.5,
      col=rgb(darkblue[1],darkblue[2],darkblue[3],0.65)) 

lines(newdat$age[index.m], newdat$lower[index.m], lty=2, lwd=2,
      col=rgb(darkblue[1],darkblue[2],darkblue[3],0.65))

lines(newdat$age[index.m], newdat$upper[index.m], lty=2, lwd=2,
      col=rgb(darkblue[1],darkblue[2],darkblue[3],0.65))


lines(newdat.f6$age[index.f6], newdat.f6$fit[index.f6], lwd=3.5,
      col=rgb(chocolate1[1], chocolate1[2], chocolate1[3],0.8)) 

lines(newdat.f6$age[index.f6], newdat.f6$lower[index.f6], lty=2, lwd=2,
      col=rgb(chocolate1[1], chocolate1[2], chocolate1[3],0.8))

lines(newdat.f6$age[index.f6], newdat.f6$upper[index.f6], lty=2, lwd=2,
      col=rgb(chocolate1[1], chocolate1[2], chocolate1[3],0.8))
