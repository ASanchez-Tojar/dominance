...
dom <- read.table("MegaDataBase-v129-201311-201611-FY-Dominance_Lundy_20170414.csv",header=TRUE,sep=',')
...
#round(table(dom.final.v2$eventSW)/c(109,182,116,88,59,126,143),1)
#mean(table(dom.final.v2$eventSW)/c(109,182,116,88,59,126,143))
#sd(table(dom.final.v2$eventSW)/c(109,182,116,88,59,126,143))
